...
const styles = `
  ...
  .reg-card-apply:hover { background: #7CB342; }
  .reg-card-apply:active { background: #5D8C2A; transform: scale(0.97); }
...
export default function Apply() {
  ...
  return (
    <div className="reg-root">
      ...
      <PageHeader
        title="행사 참가 신청"
        icon={<TicketCheck size={40} strokeWidth={1.8} style={{ color: "#8DBD52" }} />}
