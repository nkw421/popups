...
const styles = `
  ...
  .sc-day-item:hover { border-color: #7CB342; }
  .sc-day-item.active { border-color: #7CB342; background: #f5f8ff; box-shadow: 0 0 0 3px rgba(26,79,214,0.08); }
  .sc-day-icon {
    width: 44px; height: 44px; border-radius: 10px; background: #f3f4f6;
    display: flex; flex-direction: column; align-items: center; justify-content: center; flex-shrink: 0;
  }
  .sc-day-icon.active { background: #7CB342; }
  ...
  .sc-day-count {
    font-size: 11px; font-weight: 700; color: #7CB342; background: #eff4ff;
  ...
  .sc-time-label {
    font-size: 12px; font-weight: 700; color: #7CB342; background: #eff4ff;
  ...
  .sc-event-item:hover { border-color: #7CB342; background: #f8faff; }
  ...
  .sc-event-tag.session { background: #eff4ff; color: #7CB342; }
        ...
        {[
          {
            label: "행사 기간",
            value: `${days.length}일`,
            icon: <CalendarDays size={20} color="#7CB342" />,
            bg: "#eff4ff",
          },
          {
            label: "선택 일자 프로그램",
