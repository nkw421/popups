...
const styles = `
  ...
  .ex-filter-btn.active { background:#7CB342; border-color:#7CB342; color:#fff; }
  ...
  .ex-type-tag { font-size:10px; font-weight:700; background:#eff4ff; color:#7CB342; padding:3px 9px; border-radius:100px; }
          ...
          {[
            {
              label: "전체 체험존",
              value: booths.length,
              ico: <Store size={18} color="#7CB342" />,
              bg: "#eff4ff",
            },
            {
              label: "운영 중",
