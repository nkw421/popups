    ...
    <>
      ...
      <div className="ss-card">
        ...
        {!loading && !errorMsg && filtered.length === 0 ? (
          <div className="ss-card-tag">?쒖떆???몄뀡???놁뒿?덈떎.</div>
        ) : null}
            ...
            {filtered.map((s, idx) => (
              ...
              >
                ...
                <div className="ss-session-body">
                  ...
                  <div className="ss-session-desc">{s.desc || "?ㅻ챸???놁뒿?덈떎."}</div>
                  ...
                  <div className="ss-tag-list">
                    <span className="ss-tag session">?몄뀡</span>
                  </div>
                </div>
      ...
      try {
        ...
        const mapped = raw.map((item, idx) => {
          ...
          return {
            ...
            name: item?.programTitle ?? `?몄뀡 ${idx + 1}`,
            desc: item?.description ?? "",
            speaker: first?.speakerName ?? "?곗궗 ?뺣낫 ?놁쓬",
  ...
  if (!eventId) {
    return (
      <div className="ss-root">
        ...
        {eventsLoading ? (
          <main className="ss-container">
            <div className="ss-card-tag">행사 목록을 불러오는 중입니다.</div>
          </main>
        ) : null}
      </div>
    );
