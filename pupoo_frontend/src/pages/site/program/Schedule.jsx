...
const styles = `
  ...
  .pg-filter button.active { background:#7CB342; border-color:#7CB342; color:#fff; }
  ...
  .pg-thumb {
    width:100%;
    aspect-ratio: 16/10;
    background: linear-gradient(135deg,#F4F9EC 0%, #f8fafc 100%);
    position: relative;
    overflow: hidden;
  }
  .pg-thumb img {
  ...
  .pg-cat { font-size:11px; font-weight:700; color:#7CB342; background:#eff4ff; border-radius:999px; padding:3px 9px; }
  .pg-host { font-size:12px; color:#6b7280; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  .pg-detail { border:0; background:transparent; color:#7CB342; font-size:12px; font-weight:700; cursor:pointer; display:inline-flex; align-items:center; gap:4px; }
        ...
        <div className="pg-stats">
          <div className="pg-stat">
            <div className="pg-stat-ico" style={{ background: "#eff4ff" }}>
              <CalendarDays size={18} color="#7CB342" />
            </div>
            <div>
