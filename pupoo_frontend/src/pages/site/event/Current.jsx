...
const styles = `
  ...
  .ev-nav-btn.active { background: #7CB342; color: #fff; font-weight: 600; }
  ...
  .ev-event-card:hover .ev-card-btn { background: #7CB342; color: #fff; border-color: #7CB342; }
  ...
  .ev-event-category { font-size: 13px; font-weight: 700; color: #7CB342; margin-bottom: 6px; letter-spacing: 0.3px; }
  ...
  .ev-progress-fill { height: 100%; border-radius: 100px; background: linear-gradient(90deg, #7CB342, #6366f1); transition: width 0.6s ease; }
  ...
  .ev-card-btn:hover { background: #7CB342; color: #fff; border-color: #7CB342; }
