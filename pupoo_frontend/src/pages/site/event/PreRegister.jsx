...
const styles = `
  ...
  .pr-nav-btn.active { background: #7CB342; color: #fff; font-weight: 600; }
  ...
  .pr-step.active .pr-step-num { background: #7CB342; color: #fff; }
  ...
  .pr-step.active .pr-step-label { color: #7CB342; }
  ...
  .pr-input:focus { border-color: #7CB342; box-shadow: 0 0 0 3px rgba(26,79,214,0.08); }
  .pr-select {
  ...
  .pr-select:focus { border-color: #7CB342; box-shadow: 0 0 0 3px rgba(26,79,214,0.08); }
  ...
  .pr-ticket-opt:hover { border-color: #7CB342; }
  .pr-ticket-opt.selected { border-color: #7CB342; background: #f5f8ff; }
  .pr-ticket-name { font-size: 13px; font-weight: 700; color: #111827; margin-bottom: 2px; }
  .pr-ticket-price { font-size: 12px; color: #6b7280; }
  .pr-ticket-opt.selected .pr-ticket-name { color: #7CB342; }
  ...
  .pr-checkbox.checked { border-color: #7CB342; background: #7CB342; }
  ...
  .pr-summary-banner { padding: 24px; background: linear-gradient(135deg, #7CB342 0%, #6366f1 100%); color: #fff; }
  ...
  .pr-quota-fill { height: 100%; border-radius: 100px; background: #7CB342; }
  ...
  .pr-success-code { background: #f3f4f6; border-radius: 8px; padding: 14px 24px; font-size: 18px; font-weight: 800; color: #7CB342; letter-spacing: 2px; }
  ...
  return (
    <div className="pr-root">
      ...
      <PageHeader
        ...
        icon={<ClipboardList size={42} color="#7CB342" strokeWidth={1.6} />}
            ...
            <div className="pr-card">
              <div className="pr-card-title">
                <div className="pr-card-title-icon">
                  <ClipboardList size={14} color="#7CB342" />
                </div>
                사전 등록 신청
              </div>
