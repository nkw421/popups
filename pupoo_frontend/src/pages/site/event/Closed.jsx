...
function getProgramCategoryMeta(category) {
  ...
  if (normalized.includes("SESSION")) {
    return { label: "세션/강연", bg: "#F4F9EC", color: "#7CB342" };
  }
...
function downloadResultImage(event) {
  ...
  /* ── 4 metric cards ── */
  const metrics = [
    { label: "참가자", value: `${event.participants.toLocaleString()}명`, sub: `/ ${event.capacity.toLocaleString()}`, color: "#7CB342", bg: "#F4F9EC" },
  ...
  drawDonut(donutCx1, donutCy1, donutR1, 14, pct1, "#E8F2D6", "#7CB342");

  ctx.fillStyle = "#7CB342"; ctx.font = "900 32px sans-serif"; ctx.textAlign = "center";
    ...
    <div ref={ref} style={{ position: "relative" }}>
      <button
        ...
        style={{
          ...
          borderRadius: 14,
          border: open ? "2px solid #7CB342" : "1.5px solid #e2e8f0",
      ...
      >
        <Calendar size={16} color={open ? "#7CB342" : "#94a3b8"} style={{ transition: "color 0.25s" }} />
        {!open && !hasValue && (
          <span style={{
        ...
        <ChevronDown size={16} color={open ? "#7CB342" : "#94a3b8"}
            ...
            return (
              <button key={val} type="button"
                ...
                style={{
                  ...
                  background: month === val ? "#F4F9EC" : "transparent",
                  color: month === val ? "#7CB342" : "#334155",
          ...
          <>
            <div style={{ display: "flex", gap: 12, alignItems: "center", justifyContent: "flex-end", marginBottom: 18 }}>
              ...
              <div ref={yearDropRef} style={{ position: "relative", minWidth: 180 }}>
                <button
                  ...
                  style={{
                    width: "100%", height: 52, padding: "0 16px",
                    borderRadius: 14,
                    border: yearOpen ? "2px solid #7CB342" : "1.5px solid #e2e8f0",
                    background: "#fff", cursor: "pointer",
                    display: "flex", alignItems: "center", gap: 10,
                    transition: "border-color 0.25s, box-shadow 0.25s",
                ...
                >
                  <Calendar size={16} color={yearOpen ? "#7CB342" : "#94a3b8"} style={{ transition: "color 0.25s" }} />
                  {!yearOpen && year === "all" && (
                    <span style={{
                      position: "absolute", left: 42, top: "50%",
                      transform: "translateY(-50%)",
                  ...
                  <ChevronDown
                    size={16} color={yearOpen ? "#7CB342" : "#94a3b8"}
                    style={{
                    ...
                    {years.map((value) => (
                      <button
                        ...
                        style={{
                          width: "100%", padding: "10px 14px",
                          borderRadius: 10, border: "none",
                          background: year === value ? "#F4F9EC" : "transparent",
                          color: year === value ? "#7CB342" : "#334155",
              ...
              <div style={{ position: "relative", width: 280 }}>
                <Search
                  size={16}
                  color={searchFocused ? "#7CB342" : "#94a3b8"}
                  style={{
                ...
                <input
                  ...
                  style={{
                    width: "100%", height: 44,
                    borderRadius: 12,
                    border: searchFocused ? "2px solid #7CB342" : "1.5px solid #e2e8f0",
            ...
            {filtered.length > 0 && (
              <section style={{ marginBottom: 28, background: "#fff", border: "1px solid #e2e8f0", borderRadius: 20, overflow: "hidden" }}>
                <div style={{ padding: "18px 24px", borderBottom: "1px solid #f1f5f9", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  ...
                  {selected && (
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "6px 14px", borderRadius: 999, background: "#7CB342", color: "#fff", fontSize: 13, fontWeight: 700 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0 }}>
                  {filtered.slice(0, 8).map((event, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div style={{
                          fontSize: 15, fontWeight: 700, color: active ? "#7CB342" : "#555",
                          lineHeight: 1.45,
                ...
                <section ref={topSectionRef} style={{ display: "grid", gridTemplateColumns: "minmax(320px, 0.82fr) minmax(0, 1.18fr)", gap: 18, marginBottom: 18 }}>
                  <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 24, overflow: "hidden", boxShadow: "0 18px 36px rgba(15,23,42,0.05)", minHeight: 420 }}>
                    {selected.image ? (
                      ...
                      <div style={{ minHeight: 420, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, color: "#94a3b8", background: "linear-gradient(180deg, #f8fafc 0%, #F4F9EC 100%)" }}>
                        <ImageOff size={36} />
                  ...
                  <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 24, overflow: "hidden", boxShadow: "0 18px 36px rgba(15,23,42,0.05)" }}>
                    <div style={{ padding: "26px 28px", borderBottom: "1px solid #eef2f7", background: "linear-gradient(180deg, #ffffff 0%, #f8fbff 100%)" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}>
                        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 999, background: "#F4F9EC", color: "#5D8C2A", fontSize: 15, fontWeight: 500 }}>
                    ...
                    <div style={{ padding: 28 }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 14, marginTop: 22 }}>
                        <DonutStatCard
                          icon={<Users size={16} color="#7CB342" />}
                          label="참가자수"
                ...
                <>
                  <div style={{ display: "grid", gap: 0 }}>
                    {filtered.slice(0, visibleCount).map((event) => {
                      const active = event.id === selected?.id;
                      return (
                        <div key={event.id} style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) 170px 110px 140px 110px", alignItems: "center", gap: 16, padding: "16px 24px", borderTop: "1px solid #f1f5f9", background: active ? "#F4F9EC" : "#f9fafb" }}>
                          ...
                          <div style={{ display: "grid", gap: 4 }}>
                            ...
                            <div style={{ width: "100%", height: 4, borderRadius: 2, background: "#e5e7eb", overflow: "hidden" }}>
                              <div style={{ height: "100%", borderRadius: 2, background: "#7CB342", width: `${event.capacity > 0 ? clamp((event.participants / event.capacity) * 100) : 0}%`, transition: "width 0.3s" }} />
                            </div>
                          </div>
                          {(() => {
                  ...
                  {visibleCount < filtered.length && (
                    <div style={{ padding: "16px 24px", borderTop: "1px solid #f1f5f9" }}>
                      <button
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.background = "#F4F9EC"; e.currentTarget.style.borderColor = "#7CB342"; e.currentTarget.style.color = "#7CB342"; }}
