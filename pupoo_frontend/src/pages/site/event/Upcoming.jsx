...
const styles = `
  ...
  .up-nav-btn.active { background: #7CB342; color: #fff; font-weight: 600; }
  ...
  .up-status-dot { width: 8px; height: 8px; border-radius: 50%; background: #7CB342; animation: up-pulse 1.4s ease-in-out infinite; }
  .up-status-count { color: #7CB342; font-weight: 800; }
  ...
  .up-filter-btn:hover { border-color: #7CB342; color: #7CB342; }
  .up-filter-btn.active { border-color: #7CB342; background: #F4F9EC; color: #7CB342; font-weight: 700; }
  ...
  .up-thumb {
    ...
    overflow: hidden; background: #F4F9EC; position: relative;
  }
  ...
  .up-alarm-btn.off:hover { border-color: #7CB342; color: #7CB342; }
  .up-alarm-btn.on { border: 1px solid #7CB342; background: #F4F9EC; color: #7CB342; }
  .up-pre-btn {
    ...
    background: #7CB342; color: #fff; transition: all 0.15s;
  }
