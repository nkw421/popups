...
const styles = `
  ...
  .loc-map-visual {
    position: relative;
    height: 240px;
    background: linear-gradient(135deg, #F4F9EC 0%, #E4F0D0 50%, #E4F0D0 100%);
  ...
  .loc-transport-tab:hover { border-color: #5D8C2A; color: #5D8C2A; }
  .loc-transport-tab.active { background: #5D8C2A; color: #fff; border-color: #5D8C2A; }
  ...
  .loc-copy-btn:hover { border-color: #5D8C2A; color: #5D8C2A; }
  .loc-toast {
  ...
  .loc-info-card-icon.blue   { background: #F4F9EC; color: #5D8C2A; }
  ...
  .loc-tr-icon.subway { background: #F4F9EC; color: #5D8C2A; }
  ...
  .loc-tr-badge.dark   { background: #5D8C2A; color: #fff; }
          ...
          <div className="loc-col-right">
            <div className="loc-map-card">
              <div className={`loc-map-visual ${mapLoaded ? "has-map" : ""} ${mapError ? "loc-map-error" : ""}`}>
                ...
                {!mapLoaded && (
                  <div className="loc-map-loading" style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12, background: "linear-gradient(135deg, #F4F9EC 0%, #E4F0D0 50%, #E4F0D0 100%)" }}>
                    {mapError ? (
                      <>
