...
const styles = `
  ...
  .vt-refresh-btn:hover { border-color: #7CB342; color: #7CB342; background: #f5f8ff; }
  ...
  .vt-status-chip-planned { background: #F4F9EC; color: #7CB342; border: 1px solid #E4F0D0; }
  ...
  .vt-selector-status-btn.active { border-color: #7CB342; background: #F4F9EC; color: #5D8C2A; }
  ...
  .vt-selector-item.active { border-color: #7CB342; background: #f8fbff; box-shadow: 0 0 0 1px rgba(37, 99, 235, 0.12); }
  ...
  .vt-selector-link { border: 0; background: transparent; color: #7CB342; font-size: 13px; font-weight: 700; cursor: pointer; padding: 0; }
  ...
  .vt-ranking-row.selected { background: #F4F9EC; }
  ...
  return (
    <div className="vt-root">
      ...
      <PageHeader
        ...
        icon={<Vote size={42} color="#7CB342" strokeWidth={1.6} />}
