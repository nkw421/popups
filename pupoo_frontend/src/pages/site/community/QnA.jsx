      ...
      <div style={{ padding: "28px" }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <input
            ...
            onFocus={(e) => (e.target.style.borderColor = "#8DBD52")}
  ...
  return (
    <>
      <PageHeader
        ...
        icon={<CircleHelp size={42} color="#7CB342" strokeWidth={1.6} />}
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "#8DBD52")
              }
            >
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontSize: 11,
                          fontWeight: 600,
                          color: isClosed ? "#8DBD52" : "#999",
                          border: `1px solid ${isClosed ? "#8DBD52" : "#ccc"}`,
                          borderRadius: 20,
                          padding: "2px 9px",
                          marginLeft: 8,
                          whiteSpace: "nowrap",
