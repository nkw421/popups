            ...
            >
              <div>
                ...
                >
                  ...
                  행사에 {categoryLabel}을(를) {isEdit ? "수정" : "등록"}합니다
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            >
              <Field label={`${categoryLabel}명`} required>
                <input
                  ...
                  onFocus={inputFocus}
                  onBlur={inputBlur}
                  placeholder={`예: ${categoryLabel} 이름`}
                  autoFocus
                />
              </Field>
              <Field label="카테고리">
...
export default function ProgramCategoryPage({
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      await loadPrograms(eventId);
      setSelected(new Set());
      showToast(`${rows.length}건 전체 삭제되었습니다.`);
    } catch (err) {
  ...
  return (
    <div>
                  ...
                  <tr>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          이 행사에 {categoryLabel}을(를) 등록해보세요
                        </div>
                      </div>
                    </td>
                  </tr>
      ...
      {modal?.type === "delete" && (
        <ConfirmModal
          title={`${categoryLabel} 삭제`}
          msg={`"${modal.item.name}"을(를) 삭제하시겠습니까?\n삭제된 데이터는 복구할 수 없습니다.`}
